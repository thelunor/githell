 ...
 * Generated at: 2019-10-28 06:36:20 UTC
...
public final class makecategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/admin/board/categorymodify.jsp", Long.valueOf(1501663320000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t    <h2 id=\"container\">카테고리생성 및 변경</h2>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("           \t\r\n");
      out.write("           \t<script type=\"text/javascript\">\r\n");
      out.write("            $(document).ready(function() {\r\n");
      out.write("            \t$(document).on('click', '#cmodifyBtn', function() {\r\n");
      out.write("            \t\tvar ccode = $(this).parents('li').attr('data-ccode');\r\n");
      out.write("            \t\tvar oldname = $(this).parents('li').children('.cname').text();\r\n");
      out.write("            \t\t$('#categoryModifyModal').on('show.bs.modal', function(event) {\r\n");
      out.write("                \t\tvar modal = $(this);\r\n");
      out.write("                \t\tmodal.find('#oldcname').text(oldname);\r\n");
      out.write("                \t\tmodal.find('#newcname').val('');\r\n");
      out.write("                \t\tmodal.find('#ccode').val(ccode);\r\n");
      out.write("              \t\t});          \t\r\n");
      out.write("              \t\t$('#categoryModifyModal').modal();\r\n");
      out.write("            \t});\r\n");
      out.write("            \t\r\n");
      out.write("            \t$(document).on('click', '#cdeleteBtn', function() {\r\n");
      out.write("            \t\talert($(this).parents('li').attr('data-ccode'));\r\n");
      out.write("            \t});\r\n");
      out.write("            \t\r\n");
      out.write("            \t$('#createBtn').click(function() {\r\n");
      out.write("            \t\tvar cname = $('#cname').val();\r\n");
      out.write("            \t\tif($.trim(cname) == '') {\r\n");
      out.write("            \t\t\talert('카테고리 이름을 입력하세요');\r\n");
      out.write("            \t\t\treturn;\r\n");
      out.write("            \t\t} else {\r\n");
      out.write("            \t\t\talert(cname + '으로 카테고리생성!!!');\r\n");
      out.write("            \t\t}\r\n");
      out.write("            \t});\r\n");
      out.write("            });\r\n");
      out.write("            </script>\r\n");
      ...
      out.write("\t\t\t\t    \t<label class=\"col-sm-12 control-label\">현재  카테고리 목록</label>\r\n");
      out.write("\t\r\n");
      out.write("\t                    <div class=\"col-sm-12\" style=\"margin-left: 15px; padding: 10px; border: 1px solid #bcbcbc; border-radius: 5px;\">\r\n");
      out.write("\t                        <ul class=\"nav nav-pills nav-stacked\">\r\n");
      out.write("\t                        \t<li data-ccode=\"1\">\r\n");
      out.write("\t\t                        \t<div class=\"cname col-sm-10\">갤럭시S9</div>\r\n");
      out.write("\t\t                        \t<div class=\"col-sm-2\">\r\n");
      out.write("\t                        \t\t\t<button type=\"button\" id=\"cmodifyBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">이름변경</button>\r\n");
      out.write("\t\t\t\t            \t\t\t<button type=\"button\" id=\"cdeleteBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">삭제</button>\r\n");
      out.write("\t                        \t\t</div>\r\n");
      out.write("\t                        \t</li>\r\n");
      out.write("\t                        \t<li data-ccode=\"2\">\r\n");
      out.write("\t\t                        \t<div class=\"cname col-sm-10\">갤럭시Note8</div>\r\n");
      out.write("\t\t                        \t<div class=\"col-sm-2\">\r\n");
      out.write("\t                        \t\t\t<button type=\"button\" id=\"cmodifyBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">이름변경</button>\r\n");
      out.write("\t\t\t\t            \t\t\t<button type=\"button\" id=\"cdeleteBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">삭제</button>\r\n");
      out.write("\t                        \t\t</div>\r\n");
      out.write("\t                        \t</li>\r\n");
      out.write("\t                        \t<li data-ccode=\"3\">\r\n");
      out.write("\t\t                        \t<div class=\"cname col-sm-10\">아이폰8SPlus</div>\r\n");
      out.write("\t\t                        \t<div class=\"col-sm-2\">\r\n");
      out.write("\t                        \t\t\t<button type=\"button\" id=\"cmodifyBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">이름변경</button>\r\n");
      out.write("\t\t\t\t            \t\t\t<button type=\"button\" id=\"cdeleteBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">삭제</button>\r\n");
      out.write("\t                        \t\t</div>\r\n");
      out.write("\t                        \t</li>\r\n");
      out.write("\t                        \t<li data-ccode=\"4\">\r\n");
      out.write("\t\t                        \t<div class=\"cname col-sm-10\">G7</div>\r\n");
      out.write("\t\t                        \t<div class=\"col-sm-2\">\r\n");
      out.write("\t                        \t\t\t<button type=\"button\" id=\"cmodifyBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">이름변경</button>\r\n");
      out.write("\t\t\t\t            \t\t\t<button type=\"button\" id=\"cdeleteBtn\" class=\"btn btn-xs btn-link\" data-backdrop=\"static\">삭제</button>\r\n");
      out.write("\t                        \t\t</div>\r\n");
      ...
      out.write("\t                </div>\r\n");
      out.write("\t                <div class=\"form-group col-sm-12\">\r\n");
      out.write("\t\t\t\t    \t<label class=\"col-sm-12 control-label\">생성할 카테고리이름</label>\r\n");
      out.write("\t\r\n");
      out.write("\t                    <div class=\"col-sm-12\" style=\"margin-left: 15px; padding: 10px; border: 1px solid #bcbcbc; border-radius: 5px;\">\r\n");
      out.write("\t                        <div class=\"col-sm-10\">\r\n");
      out.write("\t                        \t<input type=\"text\" id=\"cname\" class=\"form-control\" placeholder=\"카테고리이름\">\r\n");
      out.write("\t                        </div>\r\n");
      out.write("\t                        <div class=\"col-sm-2\">\r\n");
      out.write("\t                        \t<button type=\"button\" id=\"createBtn\" class=\"btn btn-info\">카테고리생성</button>\r\n");
      out.write("\t                        </div>\r\n");
      out.write("\t                    </div>\r\n");
      out.write("\t                </div>\r\n");
      out.write("\t\t\t        </fieldset>\r\n");
      ...
      out.write(" \t\t\t</div>\r\n");
      out.write("       \t</div>\r\n");
      out.write("<!-- 카테고리이름변경 Modal -->\r\n");
      out.write("\r\n");
      out.write("<div id=\"categoryModifyModal\" class=\"modal fade\" role=\"dialog\">\r\n");
      out.write("\t<div class=\"modal-dialog\" style=\"width: 50%;\">\r\n");
      out.write("\t    <!-- Modal content-->\r\n");
      out.write("\t    <div class=\"modal-content\">\r\n");
      out.write("\t    \t<div class=\"modal-header\">\r\n");
      out.write("\t        \t<button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\r\n");
      out.write("\t        \t<h4 class=\"modal-title\">카테고리이름변경</h4>\r\n");
      out.write("\t      \t</div>\r\n");
      out.write("\t      \t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t    <form class=\"form-horizontal\" action=\"#\">\r\n");
      out.write("\t\t\t    \t<input type=\"hidden\" name=\"ccode\" id=\"ccode\">\r\n");
      out.write("\t\t\t    \t<fieldset>\r\n");
      out.write("\t\t\t    \t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t    \t<label class=\"col-lg-3 control-label\">기존카테고리이름</label>\r\n");
      out.write("\t\r\n");
      out.write("\t                    <label id=\"oldcname\" class=\"col-lg-8 control-label\"></label>\r\n");
      out.write("\t                </div>\r\n");
      out.write("\t\t\t        <div class=\"form-group\">\r\n");
      out.write("\t\t\t\t    \t<label class=\"col-lg-3 control-label\">변경할카테고리이름</label>\r\n");
      out.write("\t\r\n");
      out.write("\t                    <div class=\"col-lg-8\">\r\n");
      out.write("\t                        <input type=\"text\" id=\"newcname\" class=\"form-control\" placeholder=\"카테고리새이름\">\r\n");
      out.write("\t                    </div>\r\n");
      out.write("\t                </div>\r\n");
      out.write("\t\t\t        </fieldset>\r\n");
      out.write("\t\t\t    </form>\r\n");
      ...
      out.write("\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("            $(document).ready(function() {\r\n");
      out.write("            \t$('#cnameModifyBtn').click(function() {\r\n");
      out.write("            \t\talert($('#ccode').val() + '번 카테고리를 ' + $('#newcname').val() + '로 변경합니다.');\r\n");
      out.write("            \t});\r\n");
      out.write("            });\r\n");
      out.write("            </script>\r\n");
      out.write("\t      \t<div class=\"modal-footer\">\r\n");
      out.write("\t      \t\t<button type=\"button\" id=\"cnameModifyBtn\" class=\"btn btn-info\">카테고리변경</button>\r\n");
